...
<html>
    ...
    public class BookInfo{
       ...
       public ResultSet getBookInfos(String book_id,String Title)
               {
                   try{
                       selectBookInfos.setString(1,book_id);
                       selectBookInfos.setString(2,Title); 
    ...
    <%
      ...
      ResultSet bookInfos = bookInfo.getBookInfos(book_id,Title);
